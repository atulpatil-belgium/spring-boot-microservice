package com.javadeveloper.notification_service.kafkaservice.config;
...
public class KafkaConsumerConfig {
        ...
        public ConsumerFactory<String, PaymentStatusEvent> consumerFactory() {
                ...
                props.put(JsonDeserializer.VALUE_DEFAULT_TYPE,"com.javadeveloper.notification_service.kafkaservice.model.PaymentStatusEvent");
